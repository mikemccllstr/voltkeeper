...
from bluetti_cli.bluetooth.client import BluetoothClient


class TestBluetoothClientConnectEncrypted:
    @pytest.mark.asyncio
    async def test_connect_runs_handshake_when_encrypted(self):
        with patch("bluetti_cli.bluetooth.client.BleakClient", autospec=True) as mock_bleak:
            ...
            with patch("bluetti_cli.bluetooth.client.HandshakeSession") as mock_hs:
