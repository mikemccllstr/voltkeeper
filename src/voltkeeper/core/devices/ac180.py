# ABOUTME: AC180 portable power station — V2 protocol, AC180/AC180P/PLP022 family base class.
# ABOUTME: APK v3.0.9: standalone DeviceFunction, minProtocolVer=2000, category=PORTABLE_POWER.
# ABOUTME: 56V nominal. PLP022 ("PINa") and EL10V2 inherit from this base.
...
class AC180(V2Base):
    """AC180 portable power station. V2 protocol, 56V system."""
